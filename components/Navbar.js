      ...
      <Container>
        <div className="flex items-center">
          ...
          <div className={`lg:w-3/12 absolute lg:static w-full left-0 px-10 lg:px-0 transition-all ${search ? 'top-10' : '-top-40'}`}>
            ...
            <input className="bg-gray-700 py-3 px-6 w-full lg:rounded-full rounded-lg bg-search pl-12 focus:outline-none focus:shadow-md focus:duration-300" placeholder="Search ..." />
          </div>
        </div>
      </Container>
    </nav>
