...
export default function Login(){
  ...
  return(
   ...
   <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
     ...
     <form onSubmit={doLogin} className="p-16 md:p-24">
       <div className="flex items-center text-lg mb-8">
         <svg className="absolute ml-3" width={24} viewBox="0 0 24 24">
           <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z" />
         </svg>
         <input type="text" className="bg-gray-200 pl-12 py-4 focus:outline-none w-full" placeholder="Username/Email" name="identifier" minLength={3} onChange={setValues} required />
       </div>
       <div className="flex items-center text-lg mb-8">
       ...
       <button type="submit" className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-4 text-white uppercase w-full">Login</button>
       <a href={`${process.env.NEXT_PUBLIC_URL}/api/connect/github/`}><button type="button" className="border-2 border-gray-700 bg-gray-100 py-1 mt-4 uppercase w-full">Login with github</button></a>
       <p className='my-3 text-center'>Don't have an account? Register <Link href="/register"><a className='text-blue-500 underline'>here.</a></Link></p>
       {errorAlert &&(
